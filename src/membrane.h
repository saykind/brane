...
typedef struct {
    ...
    /* Per-mode Metropolis bookkeeping [L*L] (diagnostic: acceptance vs |q|,
     * i.e. is the momentum-dependent step tuned to ~uniform acceptance a la
     * Troster 2013 OFMC). NULL unless allocated.                            */
    long  *prop_k, *acc_k;
